	...
	<div class="sidebar_t">
        ...
        <div class="panel-content">
			<ul>
				...
				<li><a href="${ctx}/cargo/contract/shipList.action" onclick="linkHighlighted(this)" target="main" id="aa_1">购销合同查询</a></li>
				...
				<li><a href="${ctx}/ws/export/toview.action" onclick="linkHighlighted(this)" target="main" id="aa_1">报运单WS</a></li>
			</ul>
        </div>
        </div>
    </div>
